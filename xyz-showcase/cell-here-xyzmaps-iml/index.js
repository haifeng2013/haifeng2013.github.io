...
function getCellLayer(stds) {
    ...
    return new here.xyz.maps.layers.MVTLayer({
        ...
        max: 20,
        remote: {
            url: `https://interactive.data.api.platform.here.com/interactive/v1/catalogs/${catalogArn}/layers/${layerId}/tile/web/{z}_{x}_{y}.mvt?apiKey=${apikey}&p.radio=${stds}&clip=false&clustering=hexbin&clustering.relativeResolution=1`
        },
